...
from config import NUMBER_CORES, RESULTS_FOLDER, SNIPER_CONFIG, SCRIPT, ENABLE_HEARTBEATS, SNIPER
...
def reliabilityAware_demo():
    run(['{:.1f}GHz'.format(2.4), 'maxFreq', 'slowDVFS', 'reliabilityAware'], get_instance('parsec-blackscholes', 3, input_set='simsmall'))
