...
def create_plots(run, force_recreate=False):
    ...
    if get_config_val_bool(run, 'reliability/enabled'):
        ...
        # C_0 = get_file(run, 'PeriodicRvalues_C_0')
        # C_1 = get_file(run, 'PeriodicRvalues_C_1')
        # C_2 = get_file(run, 'PeriodicRvalues_C_2')
        # C_3 = get_file(run, 'PeriodicRvalues_C_3')
        # periodic_plot.plot_periodic_log(C_0, core_level=False, y_label='R-value')
        # periodic_plot.plot_periodic_log(C_1, core_level=False, y_label='R-value')
        # periodic_plot.plot_periodic_log(C_2, core_level=False, y_label='R-value')
        # periodic_plot.plot_periodic_log(C_3, core_level=False, y_label='R-value')
