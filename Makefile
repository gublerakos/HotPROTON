...
.PHONY: all message dependencies compile_simulator configscripts package_deps pin python linux builddir showdebugstatus distclean mbuild xed_install xed reliability proton_engine
...
dependencies: package_deps xed pin python mcpat linux builddir showdebugstatus reliability proton_engine
